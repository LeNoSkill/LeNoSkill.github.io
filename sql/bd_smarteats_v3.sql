...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 17 mai 2023 à 09:49
...
(9, 'Rowing haltères', 'Debout, penchez-vous légèrement vers l''avant avec un haltère dans chaque main, les bras tendus et les paumes face à vous. Fléchissez les coudes et tirez les haltères vers votre torse en contractant les muscles du dos. Abaissez les haltères et répétez. Effectuez cet exercice 3 à 4 fois à raison de 10 à 15 répétitions.', 15, 'Renforcement des muscles du dos et des biceps.', '../img/RowingHalteres.gif'),
(10, 'Leg press', 'Asseyez-vous sur une machine à leg press avec le dos bien appuyé contre le dossier et les pieds sur la plate-forme. Poussez avec vos jambes pour étendre les genoux et déplacer la plate-forme. Revenez à la position de départ en pliant les genoux. Effectuez cet exercice 3 à 4 fois à raison de 10 à 15 répétitions.', 15, 'Renforcement des quadriceps, ischio-jambiers et fessiers.', '../img/LegPress.gif'),
(11, 'Planche', 'Mettez-vous en position de planche avec les avant-bras au sol et les coudes alignés sous les épaules. Contractez les muscles du tronc pour maintenir le corps droit et tenez la position aussi longtemps que possible. Essayez de tenir la position pendant 30 secondes à 1 minute, puis reposez-vous et répétez 3 à 4 fois.', 10, 'Renforcement des muscles du tronc et de la ceinture abdominale.', '../img/Planche.gif'),
(12, 'Triceps dips', 'Placez vos mains sur le bord d''une chaise ou d''un banc, les paumes vers le bas et les doigts pointés vers l''avant. Abaissez votre corps en fléchissant les coudes, puis poussez vers le haut pour revenir à la position initiale. Effectuez cet exercice 3 à 4 fois à raison de 10 à 15 répétitions.', 15, 'Renforcement des triceps.', '../img/TricepsDips.gif'),
(13, 'Mountain climbers', 'Mettez-vous en position de planche avec les mains écartées à la largeur des épaules. Ramenez un genou vers votre poitrine, puis revenez en position de planche. Répétez avec l''autre jambe et continuez à alterner les jambes rapidement. Effectuez cet exercice pendant 30 secondes à 1 minute, reposez-vous et répétez 3 à 4 fois.', 10, 'Renforcement des muscles du tronc et développement de l''endurance.', '../img/MountainClimbers.gif');
...
INSERT INTO `favoris` (`ID`, `ID_utilisateur`, `ID_recette`) VALUES
(134, 1, 9),
(135, 1, 2);
...
--
-- Structure de la table `favorisexo`
--

DROP TABLE IF EXISTS `favorisexo`;
CREATE TABLE IF NOT EXISTS `favorisexo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_utilisateur` int NOT NULL,
  `id_exo` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fkfavexutil` (`id_utilisateur`),
  KEY `fkfavex` (`id_exo`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3;

--
-- Déchargement des données de la table `favorisexo`
--

INSERT INTO `favorisexo` (`id`, `id_utilisateur`, `id_exo`) VALUES
(1, 1, 1),
(2, 1, 2);
...
DROP TABLE IF EXISTS `info_nutri`;
...
(5, 0, 'mateofontaine30@gmail.com', '$2y$10$.sHGIaYBdLrNHvgr.Ljk9.PePpVlZxqwcUCQxqF62mxWYu/ApmfEa', 'Font', 'Mat', '2003-09-17', '70.0', '174.0', 'H');
