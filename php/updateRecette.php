...
if (isset($_POST['id']) && isset($_POST['name']) && isset($_POST['temps_preparation']) && isset($_POST['temps_cuisson']) && isset($_POST['instructions_preparation']) && isset($_POST['liste_ingredients']) && isset($_POST['calories_par_portion']) && isset($_POST['proteines_par_portion']) && isset($_POST['glucides_par_portion']) && isset($_POST['graisses_par_portion']) && isset($_POST['fibres_par_portion'])) {
    ...
    if ($stmt->execute([$name, $temps_preparation, $temps_cuisson, $instructions_preparation, $liste_ingredients, $calories_par_portion, $proteines_par_portion, $glucides_par_portion, $graisses_par_portion, $fibres_par_portion, $image_url, $id])) {
